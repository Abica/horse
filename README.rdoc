...
begin running.
  ...
  # this job will run as soon as the horse instance is started and will print the current
  # time in miliseconds out every frame for 10 seconds
  ...
  # autostarts, runs forever and plays a pretty disco light show on any divs on the page
